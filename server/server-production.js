...
// CORS - automatycznie wykryj domenę
...
// Strona trybu testowego
app.get('/test-practice.html', (req, res) => {
  res.sendFile(path.join(__dirname, '..', 'test-practice.html'));
});
...
// Catch all - zwróć index.html dla React Router
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, '..', 'index.html'));
});
...
const server = app.listen(PORT, () => {
  ...
  console.log(`Dozwolone domeny: ${allowedOrigins.join(', ')}`);
});
